...
// Current version
if ( ! defined( 'TRX_ADDONS_VERSION' ) ) define( 'TRX_ADDONS_VERSION', '1.6.38.4' );
...
if ( ! function_exists( 'drone_media_trx_addons_privacy_text' ) ) {
    add_filter( 'trx_addons_filter_privacy_text', 'drone_media_trx_addons_privacy_text' );
    function drone_media_trx_addons_privacy_text( $text='' ) {
        return drone_media_get_privacy_text();
    }
}
