...
if (in_array($args['slider_pagination'], apply_filters('trx_addons_filter_slider_pagination_outside', array('bottom', 'bottom_outside', 'bottom_left', 'bottom_right'), $args))) trx_addons_show_layout($pagination);
