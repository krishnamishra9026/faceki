		...
		?>>
			...
			?><div class="sc_price_item_info"><?php
				...
				if (!empty($item['link']) && !empty($item['link_text'])) {
					?><a href="<?php echo esc_url($item['link']); ?>" class="<?php echo esc_attr(apply_filters('trx_addons_filter_sc_item_link_classes', 'sc_price_item_link sc_button', 'sc_price', $args, $item)); ?>" <?php if (!empty($item['new_window'])) echo ' target="_blank"'; ?>><?php
			...
			if (!empty($item['link']) && empty($item['link_text'])) {
				?><a href="<?php echo esc_url($item['link']); ?>" class="<?php echo esc_attr(apply_filters('trx_addons_filter_sc_item_link_classes', 'sc_price_item_link sc_price_item_link_over', 'sc_price', $args, $item)); ?>" " <?php if (!empty($args['new_window'])) echo ' target="_blank"'; ?>></a><?php
			}
		?></div><?php
