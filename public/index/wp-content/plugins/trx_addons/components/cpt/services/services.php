		...
		$params = array_merge(
				array(
                    ...
                    array(
                        ...
                        "heading" => esc_html__("Disable link", 'trx_addons'),
                        "description" => wp_kses_data( __("Disable services title link", 'trx_addons') ),
                        "admin_label" => true,
                        "std" => "0",
                        "value" => array(esc_html__("Disable link", 'trx_addons') => "1" ),
                        "type" => "checkbox"
                    ),
				),
