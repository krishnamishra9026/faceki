			...
			<div class="team_member_details">
				...
				foreach ($meta_box as $k=>$v) {
					if (!empty($v['details']) && !empty($meta[$k])) {
						?><div class="team_member_details_<?php echo esc_attr($k); ?>"><span class="team_member_details_label"><?php echo esc_html($v['title']); ?>: </span>
                        <span class="team_member_details_value"><?php
                            if ($k == "email") {
                                echo '<a href="mailto:'.$meta[$k].'">'.$meta[$k].'</a>'; ?></span></div><?php
                            }
                            else {
