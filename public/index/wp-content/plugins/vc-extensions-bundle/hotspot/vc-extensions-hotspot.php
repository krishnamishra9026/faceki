    ...
    class VC_Extensions_HotSpot {
          ...
          vc_map( array(
            ...
            "params" => array(
              ...
              array(
                ...
                "holder" => "",
                "class" => "vc_hotspot_cq",
                "heading" => __("Open the link as lightbox?", "vc_hotspot_cq"),
                "param_name" => "islightbox",
                "value" => array(__("no", "vc_hotspot_cq") => "no", __("yes", "vc_hotspot_cq") => "yes"),
                "description" => __("Support YouTube, Vimeo video, image, or Google Map etc.", "vc_hotspot_cq")
              ),
              array(
                "type" => "colorpicker",
                "holder" => "div",
      ...
      function cq_vc_hotspot_func($atts, $content=null, $tag) {
          ...
          foreach ($contentarr as $key => $thecontent) {
             ...
             if($links[$i]!=""){
                 $output .= '<a href="'.$links[$i].'" class="cq-tooltip" style="background:'.$iconcolor.';" '.$is_lity.' data-tooltip="'.htmlspecialchars($tooltipcontent).'" data-arrowposition="'.trim($arrowposition[$i]).'" target="'.$custom_links_target.'">';
             }else{
