...
?>>
	...
	<div class="sc_services_item_info">
		<div class="sc_services_item_header">
			...
			?>
			<<?php echo esc_html($title_tag); ?> class="sc_services_item_title<?php if (!$price_showed && !empty($meta['price'])) echo ' with_price'; ?>">
			
			<?php
            // Disable_link
            if (!empty($args['disable_link'])) {
                the_title();
            } else { ?>
		...
		<?php if (!isset($args['hide_excerpt']) || $args['hide_excerpt']==0) { ?>
			...
			<div class="sc_services_item_button sc_item_button"><a href="<?php echo esc_url($link); ?>" class="<?php echo esc_attr(apply_filters('trx_addons_filter_sc_item_link_classes', 'sc_button sc_button_simple', 'sc_services', $args)); ?>"><?php esc_html_e('Learn more', 'drone-media'); ?></a></div>
		<?php } ?>
	</div>
</div>
<?php
