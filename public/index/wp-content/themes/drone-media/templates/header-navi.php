...
<div class="top_panel_navi sc_layouts_row sc_layouts_row_type_compact sc_layouts_row_fixed sc_layouts_row_fixed_always<?php
			if (false) {
			echo ' scheme_'. esc_attr(drone_media_is_inherit(drone_media_get_theme_option('menu_scheme')) 
		...
		<div class="columns_wrap columns_fluid">
			...
			?><div class="sc_layouts_column sc_layouts_column_align_right sc_layouts_column_icons_position_left sc_layouts_column_fluid column-3_4">
				<div class="sc_layouts_item">
					<?php
					// Main menu
					$drone_media_menu_main = drone_media_get_nav_menu(array(
						'location' => 'menu_main', 
						'class' => 'sc_layouts_menu sc_layouts_menu_default sc_layouts_hide_on_mobile'
						)
					);
					// Show any menu if no menu selected in the location 'menu_main'
					if (drone_media_get_theme_setting('autoselect_menu') && empty($drone_media_menu_main)) {
						$drone_media_menu_main = drone_media_get_nav_menu(array(
							'class' => 'sc_layouts_menu sc_layouts_menu_default sc_layouts_hide_on_mobile'
							)
						);
					}
					drone_media_show_layout($drone_media_menu_main);
					// Mobile menu button
					?>
				...
				if (drone_media_exists_trx_addons()) {
					?><div class="sc_layouts_item"><?php
						...
						do_action('drone_media_action_search', 'fullscreen', 'header_search', false);
					?></div><?php
				}
				?>
			</div>
