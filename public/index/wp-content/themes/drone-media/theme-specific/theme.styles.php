...
if (!function_exists('drone_media_customizer_get_css')) {

	function drone_media_customizer_get_css($colors=null, $fonts=null, $remove_spaces=true, $only_scheme='') {
		...
		if ($fonts) {
			...
			$fonts = drone_media_customizer_add_theme_fonts($fonts);
...
CSS;
			$rez = apply_filters('drone_media_filter_get_css', $rez, false, $fonts, '');
			$css['fonts'] = $rez['fonts'];
...
CSS;
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($only_scheme) ? array_keys(drone_media_get_list_schemes()) : array($only_scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $scheme) {
					// Prepare colors
					if (empty($only_scheme)) $colors = drone_media_get_scheme_colors($scheme);
	
					// Make theme-specific colors and tints
					$colors = drone_media_customizer_add_theme_colors($colors);
...
h1 a:hover, h2 a:hover, h3 a:hover, h4 a:hover, h4 a:hover > *, h5 a:hover, h6 a:hover,
li a:hover {
	color: {$colors['text_link']};
}
.color_style_link2 h1 a:hover, .color_style_link2 h2 a:hover, .color_style_link2 h3 a:hover, .color_style_link2 h4 a:hover,.color_style_link2 h4 a:hover > *, .color_style_link2 h5 a:hover, .color_style_link2 h6 a:hover, .color_style_link2 li a:hover {
	color: {$colors['text_link2']};
}
.color_style_link3 h1 a:hover, .color_style_link3 h2 a:hover, .color_style_link3 h3 a:hover, .color_style_link3 h4 a:hover,.color_style_link3 h4 a:hover > *, .color_style_link3 h5 a:hover, .color_style_link3 h6 a:hover, .color_style_link3 li a:hover {
	color: {$colors['text_link3']};
}
.color_style_dark h1 a:hover, .color_style_dark h2 a:hover, .color_style_dark h3 a:hover, .color_style_dark h4 a:hover,.color_style_dark h4 a:hover > *, .color_style_dark h5 a:hover, .color_style_dark h6 a:hover, .color_style_dark li a:hover {
	color: {$colors['text_link']};
}
...
blockquote dt, blockquote b, blockquote strong, blockquote mark, blockquote ins {	
	color: {$colors['text_light']};
}
...
.sc_layouts_row_type_normal .elementor-button-info .elementor-button-wrapper .elementor-button,
...
.sc_layouts_cart_widget .widget_shopping_cart .widget_shopping_cart_content .buttons .button:hover {
    color: {$colors['inverse_link']} !important;
...
.sc_layouts_cart:hover .sc_layouts_item_icon {
	color: {$colors['text_link']} !important;
}
...
.sc_layouts_row_type_normal .elementor-button-info .elementor-button-wrapper .elementor-button:hover,
...
.sc_layouts_row_type_normal .sc_layouts_search .search_wrap.search_style_fullscreen .search_field {
    background-color: {$colors['text_hover']};
}
.sc_layouts_row_type_normal .sc_layouts_search .search_wrap.search_style_fullscreen:not(.search_opened) .search_submit:hover {
    background-color: {$colors['text_hover']};
}
.sc_layouts_row_type_normal .sc_layouts_search .search_wrap.search_style_fullscreen .search_submit:hover:before {
	color: {$colors['text_link']};
}
...
.sc_layouts_menu .sc_layouts_menu_nav > li li > a:hover,
.sc_layouts_menu .sc_layouts_menu_nav > li li > a:hover:after {
...
.top_panel_default .scheme_self.top_panel_title {
	background-color: {$colors['alter_bg_color']};
}
...
.drone_media_tabs .drone_media_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.drone_media_tabs .drone_media_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
.footer_wrap.scheme_self .mejs-container .mejs-controls {
    background-color: {$colors['text_link']};
}
.footer_wrap.scheme_self .mejs-container .mejs-controls .mejs-button {
    color: {$colors['text_dark']} !important;
}
.footer_wrap.scheme_self .mejs-container .mejs-controls .mejs-button:hover {
...
.scheme_self.sidebar h1 a:hover, .scheme_self.sidebar h2 a:hover, .scheme_self.sidebar h3 a:hover, .scheme_self.sidebar h4 a:hover,.scheme_self.sidebar h4 a:hover > *, .scheme_self.sidebar h5 a:hover, .scheme_self.sidebar h6 a:hover {
	color: {$colors['alter_link']};
}
...
.sidebar[class*="scheme_"] .widget .widget_title:before {
        background: linear-gradient(to right,{$colors['text_link']} 0%, {$colors['text_link']} 66%, rgba(255,255,255,0) 66%,rgba(255,255,255,0) 71%,{$colors['text_link_05']} 71%);
}
h2.elementor-heading-title:before,
.sc_item_title.sc_item_title_style_default:before {
 background: linear-gradient(to right,{$colors['extra_link2']} 0%, {$colors['extra_link2']} 65%, rgba(255,255,255,0) 65%,rgba(255,255,255,0) 71%,{$colors['extra_link2_05']} 71%);
}
...
.sidebar[class*="scheme_"] .widget.widget_search .widget_title:before {
    background: linear-gradient(to right,{$colors['inverse_link']} 0%, {$colors['inverse_link']} 66%, rgba(255,255,255,0) 66%,rgba(255,255,255,0) 71%,{$colors['inverse_link_05']} 71%);
}
...
.wp-block-calendar .wp-calendar-table>tbody>tr>td a:hover,
...
.wp-block-calendar .wp-calendar-table>tbody>tr>td#today a:hover,
...
.wp-block-calendar .wp-calendar-table>tbody>tr>td#today a:after,
.widget_calendar td#today a:after {
	background-color: {$colors['inverse_link']};
}.wp-block-calendar .wp-calendar-table>tbody>tr>td#today a:hover:after,
...
.footer_wrap.scheme_self .widget_calendar .wp-calendar-nav .wp-calendar-nav-prev a,
.footer_wrap.scheme_self .widget_calendar .wp-calendar-nav .wp-calendar-nav-next a {
	color: {$colors['text_dark']};
}
...
.footer_wrap .widget_calendar .calendar_wrap .wp-calendar-nav a:hover{
    color: {$colors['text_link']};
}
...
CSS;
					...
					$rez = apply_filters('drone_media_filter_get_css', $rez, $colors, false, $scheme);
		...
		return apply_filters( 'drone_media_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>