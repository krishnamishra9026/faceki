...
if ( ! function_exists( 'drone_media_gutenberg_get_css' ) ) {
	add_filter( 'drone_media_filter_get_css', 'drone_media_gutenberg_get_css', 10, 4 );
	function drone_media_gutenberg_get_css($css, $colors, $fonts, $scheme='') {
