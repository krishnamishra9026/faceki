...
if (!function_exists('drone_media_trx_addons_get_css')) {
	add_filter('drone_media_filter_get_css', 'drone_media_trx_addons_get_css', 10, 4);
	function drone_media_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
/* Googlemap */
/* Elementor Googlemap */
section.elementor-element.elementor-custom_googlemap .elementor-custom_googlemap_content,
...
.scheme_self.footer_wrap .elementor-widget-trx_sc_socials .social_item .social_icon,
...
.scheme_self.footer_wrap .sc_layouts_row_type_compact .socials_wrap .social_item .social_icon {
	color: {$colors['text_05']};
	background-color: transparent;
}
.scheme_self.footer_wrap .elementor-widget-trx_sc_socials .social_item:hover .social_icon,
...
.bordered_slides .slider_height_auto.slider_container.slider_type_images .slider-slide:hover {
	border-color: {$colors['text_link']};
}
